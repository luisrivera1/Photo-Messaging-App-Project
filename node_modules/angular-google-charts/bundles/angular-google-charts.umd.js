(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('angular-google-charts', ['exports', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['angular-google-charts'] = {}),global.rxjs,global.rxjs.operators,global.ng.core));
         ...
         */
            function (columnNames) {
                ...
                if (this.roles) {
                    ...
                    /** @type {?} */
                    var copyRoles_1 = this.roles.map(function (role) { return Object.assign({}, role); });
                    copyRoles_1.forEach(function (role) {
                        var e_1, _a;
                        /** @type {?} */
                        var roleData = {
                            type: role.type,
